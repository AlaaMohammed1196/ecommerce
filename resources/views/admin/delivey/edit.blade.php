...
<div class="main-panel">
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="form-group">
            ...
            <input type='text' name='username' class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}"   value="{{ $delivery->username}}"/>
        ...
        <div class="form-group">
            ...
            <input type='email' name='email' class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"   value="{{ $delivery->email}}"/>
            @if($errors->has('email'))
                <span class="invalid-feedback" role="alert">
