...
<td>
      <a href="{{route('size.edit',$size->id)}}" class="btn btn-info btn-sm"><i class="mdi mdi-table-edit"></i></a>

       <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal-{{$size->id}}"><i class="mdi mdi-delete-forever"></i></a>
     
      <div class="modal fade" id="exampleModal-{{$size->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-{{$size->id}}"  aria-hidden="true">
                      <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel-{{$size->id}}"> حذف </h5>
